...
//        Number number = 100;
//
//        MyFunction<Apple,RedApple> T_R = apple ->  new RedApple(apple) ;
//        MyFunction<? super Number, ? extends Apple> V_T = x -> new Apple("red", 100) ;
//        Apple apply = V_T.apply(new Integer(9));
//        Apple apply1 = V_T.apply(number);
//        MyFunction<Integer, RedApple> compose = T_R.compose(V_T);
